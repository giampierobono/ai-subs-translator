 ...
 */
export type OpenSubtitlesErrorType = 'not_found' | 'rate_limit' | 'authentication' | 'server_error' | 'network_error' | 'invalid_request' | 'unknown';
/**
...
//# sourceMappingURL=opensubtitles.d.ts.map